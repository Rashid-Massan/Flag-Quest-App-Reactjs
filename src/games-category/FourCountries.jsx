...
function FourCountries({allCountries}){
...
return <div className="h-screen flex justify-center ">
        ...
        <div className="flex w-full justify-between p-2 items-center">
            ...
            <div className="flex gap-1">
                {[...Array(3)].map((item, index)=>{
                    return index< numberOfLives? <FaHeart className="text-red-500 text-2xl" key={index}/> : <FaRegHeart className="text-red-500 text-2xl" key={index} />;
                })}
            </div>
        </div>
    ...
    <div className={`absolute min-h-[100%] bg-[#000000c9] size-full flex justify-center items-center ${numberOfLives==0?'scale-100':'scale-0'} transition-all flex-col gap-8`}>
